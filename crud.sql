...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3279452448ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="535">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=crud&table=login">`crud`.`login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=testing&table=users">`testing`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Ecommerce&table=brands">`Ecommerce`.`brands`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Ecommerce&table=colors">`Ecommerce`.`colors`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Ecommerce&table=products">`Ecommerce`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=TeaShop&table=tables">`TeaShop`.`tables`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=TeaShop&table=orders">`TeaShop`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=TeaShop&table=carts">`TeaShop`.`carts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=TeaShop&table=maxtables">`TeaShop`.`maxtables`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=TeaShop&table=products">`TeaShop`.`products`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="433147616240312e3a604b784376404b">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="535"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
